...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.BuildView=void 0;var e=require("preact"),r=require("preact/hooks"),a=require("preact-router"),l=g(require("clsx"));require("./build-view.css");var n=f(require("@lhci/utils/src/lodash.js")),t=require("../../components/async-loader"),i=require("../../hooks/use-api-data"),o=require("./build-hash-selector"),s=require("./build-selector-header-section"),u=require("../../layout/page"),c=require("./build-view-warnings"),d=require("../../components/document-title"),h=require("../../components/loading-spinner"),p=require("./lhr-comparison.jsx"),m=require("../../components/dropdown");function b(){if("function"!=typeof WeakMap)return null;var e=new WeakMap;return b=function(){return e},e}function f(e){if(e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var r=b();if(r&&r.has(e))return r.get(e);var a={},l=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var n in e)if(Object.prototype.hasOwnProperty.call(e,n)){var t=l?Object.getOwnPropertyDescriptor(e,n):null;t&&(t.get||t.set)?Object.defineProperty(a,n,t):a[n]=e[n]}return a.default=e,r&&r.set(e,a),a}function g(e){return e&&e.__esModule?e:{default:e}}function B(e,r){if(e.compareUrl)return e.compareUrl;if(!r.length)return"";const a=r[0].url;return n.groupBy(e.runs,e=>e.url).filter(e=>new Set(e.map(e=>e.buildId)).size>1).map(e=>e[0].url).sort((e,r)=>e.length-r.length)[0]||a}const w=n=>{const[t,i]=(0,r.useState)(null),[h,b]=(0,r.useState)(!1),[f,g]=(0,r.useState)(!1),w=(0,r.useCallback)(()=>i(null),[i]),v=n.runs.filter(e=>e.buildId===n.build.id),y=n.compareUrl||B(n,v),O=n.baseUrl||y,L=[...new Set(v.map(e=>e.url))],S=v.find(e=>e.url===y),U=n.ancestorBuild&&n.ancestorBuild.id,k=n.runs.filter(e=>e.buildId===U).find(e=>e.url===O),q=L.map(e=>({value:e,label:e}));let j,P,R;try{j=(0,r.useMemo)(()=>S&&JSON.parse(S.lhr),[S])}catch(M){R=M}try{P=(0,r.useMemo)(()=>k&&JSON.parse(k.lhr),[k])}catch(M){R=M}if(!S||!j)return(0,e.h)(e.Fragment,null,(0,e.h)("h1",null,"No runs for build"),(0,e.h)("pre",null,R,JSON.stringify(n,null,2)));const D={lhr:j,build:n.build,baseBuild:n.ancestorBuild,baseLhr:P,hasBaseOverride:n.hasBaseOverride};return(0,e.h)(u.Page,{headerLeft:(0,e.h)(a.Link,{href:"/app/projects/".concat(n.project.slug)},(0,e.h)("i",{className:"material-icons"},"arrow_back")),header:(0,e.h)(e.Fragment,null,(0,e.h)(s.BuildSelectorHeaderSection,{build:n.ancestorBuild,variant:"base",lhr:P,isDimmed:"compare"===t,isOpen:"base"===t,setLhrLinkHover:b,onClick:()=>i("base"===t?null:"base")}),(0,e.h)(s.BuildSelectorHeaderSection,{build:n.build,variant:"compare",lhr:j,isDimmed:"base"===t,isOpen:"compare"===t,setLhrLinkHover:g,onClick:()=>i("compare"===t?null:"compare")})),headerRight:(0,e.h)("a",{href:"https://github.com/GoogleChrome/lighthouse-ci",target:"_blank",rel:"noopener noreferrer"},(0,e.h)("i",{className:"material-icons"},"info"))},(0,e.h)(d.DocumentTitle,{title:'Compare "'.concat(n.build.commitMessage,'"')}),t?(0,e.h)(o.BuildHashSelector,{build:n.build,ancestorBuild:n.ancestorBuild,selector:t,lhr:j,baseLhr:P,baseBranch:n.project.baseBranch,close:w}):(0,e.h)(e.Fragment,null),R&&(0,e.h)("h1",null,"Error parsing LHR (",R.stack,")")||(0,e.h)(e.Fragment,null),(0,e.h)(p.LhrComparison,{lhr:j,baseLhr:P,className:(0,l.default)({"build-view--with-lhr-base-link-hover":h,"build-view--with-lhr-compare-link-hover":f}),hookElements:{warnings:(0,c.computeWarnings)(D).hasWarning?(0,e.h)(c.BuildViewWarnings,D):void 0,dropdowns:(0,e.h)(e.Fragment,null,(0,e.h)(m.Dropdown,{label:"Base URL",className:"dropdown--url dropdown--base-url",value:O,setValue:e=>{const r=new URL(window.location.href);r.searchParams.set("baseUrl",e),r.searchParams.set("compareUrl",y),(0,a.route)("".concat(r.pathname).concat(r.search))},options:q}),(0,e.h)(m.Dropdown,{label:"Compare URL",className:"dropdown--url dropdown--compare-url",value:y,setValue:e=>{const r=new URL(window.location.href);r.searchParams.set("baseUrl",O),r.searchParams.set("compareUrl",e),(0,a.route)("".concat(r.pathname).concat(r.search))},options:q}))}}))},v=r=>{const a=(0,i.useProjectBySlug)(r.projectSlug),l=a[1]&&a[1].id,n=(0,i.useBuild)(l,r.partialBuildId),o=n[1]&&n[1].id,s=(0,i.useAncestorBuild)(l,o),c=r.baseBuild?r.baseBuild:null,d=(0,i.useOptionalBuildById)(l,c),p=r.baseBuild?d:s,m=p[1]&&p[1].id,b=(0,i.useOptionalBuildRepresentativeRuns)(l,o,null),f=(0,i.useOptionalBuildRepresentativeRuns)(l,null===m?"EMPTY_QUERY":m,null);return(0,e.h)(t.AsyncLoader,{loadingState:(0,t.combineLoadingStates)(a,n,p,b,f),asyncData:(0,t.combineAsyncData)(a,n,p,b,f),renderLoading:()=>(0,e.h)(u.Page,null,(0,e.h)(h.LoadingSpinner,null)),render:([a,l,n,t,i])=>(0,e.h)(w,{project:a,build:l,baseUrl:r.baseUrl,compareUrl:r.compareUrl,ancestorBuild:n,runs:t.concat(i),hasBaseOverride:!!r.baseBuild})})};exports.BuildView=v;
...
//# sourceMappingURL=/app/build-view.06a53d7f.js.map